...
Normal_condition11:Detect SA. Category is "furuits_box". Components is {'apple':2, 'watermelon':1, 'grape':[(600, 100), (735,700), (1490, 700), (1490, 100)], 'cherry':(600, 700, 1080, 1240)}.
Function11:
def execute_command11(image_path, image):
    category = "fruit_box"
    components = {'apple':2, 'watermelon':1, 'grape':[(600, 100), (735,700), (1490, 700), (1490, 100)], 'cherry':(600, 700, 1080, 1240)}
...
Normal_condition12:Detect SA. Category is "chocolate_box". Components is {'white chocolate':5, 'black chocolate':5}.
Function12:
def execute_command12(image_path, image):
    category = "chocolate_box"
    components = {'white chocolate':5, 'black chocolate':5}
...
Normal_condition13:Detect SA. Category is "chocolate_box". Components is {'white chocolate':5, ('black chocolate', 'apple chocolate'):5}.
Function13:
def execute_command13(image_path, image):
    category = "chocolate_box"
    components = {'white chocolate':5, ('black chocolate', 'apple chocolate'):5}
...
Normal_condition14:The [chocolate] in the image is white.
Function14:
...
Normal_condition15:If the car's color is black, the car type is a Mercedes-Benz.
Function15:
...
Normal_condition16:If the shoe's color is red, the type of ball in the image is a basketball.
Function16:
